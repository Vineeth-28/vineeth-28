...
[![AWS](https://img.shields.io/badge/AWS_SAA--C03-In_Progress-FF9900?style=flat-square&logo=amazonaws&logoColor=white)](https://vineeth-28.github.io)
...
- 🐳 I deploy and operate containerized workloads with **Docker**, and I'm extending into **Kubernetes**
- ⚙️ I automate build → test → deploy with **GitHub Actions**, with security scanning built into every pipeline
...
- 🎓 Currently preparing for **AWS Certified Solutions Architect – Associate (SAA-C03)** — expected September 2026
...
| **[DevSecOps CI/CD Toolkit](https://github.com/Vineeth-28/devsecops-cheatsheets)** | Reusable GitHub Actions workflows with automated Trivy (CVE) and Gitleaks (secrets) scanning built into every pipeline | GitHub Actions · Docker · DevSecOps |
| **[CI/CD Pipeline — Matrix Testing & Deployment](https://github.com/Vineeth-28/Matrix-Strategy-Github-Actions)** | 3-stage pipeline: matrix testing across Python versions, Docker build & push, automated deployment via self-hosted runner | GitHub Actions · Docker · Python |
...
| ⚙️ **CI/CD & Security** | ![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-2088FF?style=flat-square&logo=githubactions&logoColor=white) ![Trivy](https://img.shields.io/badge/Trivy-1904DA?style=flat-square&logo=aquasecurity&logoColor=white) |
...
- 📖 Daily DevOps fundamentals practice — Linux, Git, Docker, Kubernetes, Terraform, CI/CD, monitoring
- 🎓 AWS Certified Solutions Architect – Associate (SAA-C03) — expected September 2026
...
📧 [VineetPrakash918@gmail.com](mailto:VineetPrakash918@gmail.com) · 🌐 [vineeth-28.github.io](https://vineeth-28.github.io) · 📍 Noida, India
